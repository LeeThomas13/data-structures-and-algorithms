...
const addTea = () => {
    let thatSauce = ('<li>tea</li>');
    return $('ul').append(thatSauce);
};
...
const forLoopTwoToThe = (arr) => {
    let mcGriddle = [];
    arr.forEach ((spaget) => {
        let sauce = Math.pow(2, spaget);
        mcGriddle.push(sauce);
    });
    return mcGriddle;
};
...
const forEachTwoToThe = (arr) => {
  let newArrayForCodeChallengeZeroSevenQuestionThree = [];
  arr.forEach((veryLongNameForWhatTheForEachIsTakingIn) => {
      let thisRandomVariableCouldBeNamedBananas = Math.pow(2, veryLongNameForWhatTheForEachIsTakingIn);
      newArrayForCodeChallengeZeroSevenQuestionThree.push(thisRandomVariableCouldBeNamedBananas);
  });
  return newArrayForCodeChallengeZeroSevenQuestionThree;
};

/* ------------------------------------------------------------------------------------------------
CHALLENGE 4

Write a function named mapTwoToThe that produces the same output as your forLoopTwoToThe function from challenge 1 and your forEachTwoToThe function from challenge 2, 
but uses map instead of a for loop or forEach.
------------------------------------------------------------------------------------------------ */

const mapTwoToThe = (arr) => {
    let thisVariable = arr.map(obj => {
